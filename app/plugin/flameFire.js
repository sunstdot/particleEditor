 ...
 */
//it should be modify color,modify gravity and modify the speed

export function flameFire(myCanvas){
...
function particle() {
    ...
    this.color.g=Math.floor(Math.random()*25);
    this.color.b=Math.floor(Math.random()*25);
}
